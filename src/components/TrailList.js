...
class TrailList extends React.Component {
  ...
  renderTrail = (trail) => {
    const {
      selected, trailSelected, modifyTrail, hydrants, toggledEditing, editableTrail,
    } = this.props;
  ...
  render() {
    const {
      trails, trailSelected, selected, hydrants, newTrailClicked,
      interactionChanged, dataImported, manualAssignmentItemsAdded, openManualAssignment,
      manualAssignmentItems, toggleOrphanSelect, orphanRowSelected,
    } = this.props;
